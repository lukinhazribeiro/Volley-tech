...
export function HubHistoryView() {
  ...
  const [wizardMode, setWizardMode] = useState<"local" | "scout-view" | "vha" | null>(null)
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-[var(--hub-muted)]">
          Importe scouts do Scout Volleyball, análises do Scout View IA ou arquivos .vha. O histórico
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <HubCard onClick={() => setWizardMode("scout-view")}>
          <div className="flex items-start gap-3">
            <div className="rounded-xl bg-[var(--hub-accent)]/15 p-2.5">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[var(--hub-muted)]">
                Lê as análises por vídeo salvas na sua conta e traz o desempenho por atleta para o Hub.
              </p>
            </div>
          </div>
        </HubCard>
