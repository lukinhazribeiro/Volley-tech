...
import type { ActionMatch } from "@/lib/scout-action/types"
...
export function ImportWizard({
  ...
  const actionMatchesRef = useRef<ActionMatch[]>([])
      ...
      if (candidates.length === 0) {
        setError(
          mode === "video"
            ...
            : mode === "action"
              ? "Os jogos selecionados não têm atletas com nome ou ações registradas. Cadastre o elenco ao criar o scout no Scout Action."
