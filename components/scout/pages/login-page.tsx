...
import { Label } from "@/components/scout/ui/label"
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-white flex items-center justify-center p-4 relative overflow-hidden">
      <div className="w-full max-w-6xl flex items-center justify-between gap-12 relative z-10">
        <div className="w-full max-w-md">
          <div className="border border-orange-100 rounded-2xl p-8 bg-white shadow-2xl">
            <div className="mb-8">
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              {!isLogin && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-orange-500"
                    required={!isLogin}
                  />
                </div>
              )}
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-orange-600 hover:bg-orange-700 text-white font-semibold mt-6"
              >
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-400 uppercase text-xs">
                  Ou continue com
                </span>
              </div>
            </div>
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full h-12 border-slate-200 bg-white hover:bg-slate-50 text-slate-700"
            >
